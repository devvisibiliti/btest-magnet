...
export default function SuperHeader() {
  return (
    <div className="bg-black text-white text-sm py-2 px-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between sm:justify-center gap-4 flex-wrap">

        {/* LEFT: Email + Phone */}
        <div className="flex items-center gap-4 sm:absolute sm:left-4">
          <p className="hidden sm:block">info.visibiliti@gmail.com</p>
